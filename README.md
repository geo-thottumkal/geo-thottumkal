...
|------------|---------------|---------------|
| **[AgriShop – E-Commerce Platform for Farmers](https://github.com/geo-thottumkal/AgriShop)** | Developed an e-commerce platform for farmers to purchase agricultural essentials like fertilizers, pesticides, and tools. The platform promotes sustainable farming practices and offers educational resources. | HTML, CSS, JavaScript, Python, SQLite3 |
